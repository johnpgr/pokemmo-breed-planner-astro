...
export class Breeder {
    ...
    private checkBreedability(
        ...
        if (parent1.gender === PokemonGender.Genderless) {
            const parent1GenderlessEvoTree = GENDERLESS_POKEMON_EVOLUTION_TREE[parent1.species.number as keyof typeof GENDERLESS_POKEMON_EVOLUTION_TREE]
        ...
        if (parent2.gender === PokemonGender.Genderless) {
            const parent2GenderlessEvoTree = GENDERLESS_POKEMON_EVOLUTION_TREE[parent2.species.number as keyof typeof GENDERLESS_POKEMON_EVOLUTION_TREE]
        ...
        const eggTypeCompatible = parent1.species.eggGroups.some(
            (e) => parent2.species!.eggGroups.includes(e),
        )
